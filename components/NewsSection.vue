<template>
  <section class="px-5 py-10 dark:bg-black dark:text-gray-100">
    <div class="container grid grid-cols-12 mx-auto gap-y-6 md:gap-10 lg:h-[600px]">
      ...
      <div class="hidden xl:col-span-3 lg:col-span-4 md:hidden lg:block">
        <div class="mb-8 space-x-5 border-b-2 border-opacity-10 dark:border-violet-400">
          <button :class="[activeTab === 'latest' ? 'dark:border-violet-400' : 'dark:border-transparent dark:text-gray-400']" type="button" class="pb-2 text-xs font-bold uppercase border-b-2" @click="activeTab = 'latest'">
            Latest
          </button>
          <button  :class="[activeTab === 'popular' ? 'dark:border-violet-400' : 'dark:border-transparent dark:text-gray-400']" type="button" class="pb-2 text-xs font-bold uppercase border-b-2" @click="activeTab = 'popular'">
            Popular
          </button>
        </div>
        <div v-if="activeTab === 'latest'" class="flex flex-col divide-y divide-gray-700">
        ...
        <div v-if="activeTab === 'popular'" class="flex flex-col divide-y divide-gray-700">
          <div class="flex px-1 py-4">
            <img alt="" class="flex-shrink-0 object-cover w-20 h-20 mr-4 dark:bg-gray-500" src="https://source.unsplash.com/random/244x324">
            <div class="flex flex-col flex-grow">
              <a rel="noopener noreferrer" href="#" class="font-serif hover:underline">Aenean ac tristique lorem, ut mollis dui.</a>

  ...
  <main class="lg:flex justify-start items-start gap-x-10 space-y-10 lg:space-y-0">
    <section class="bg-white lg:w-7/12 rounded-md border">
      ...
      <div class="p-10 space-y-6">
        ...
        <div class="space-y-1">
          <label class="text-xs text-gray-700 font-medium">Bitcoin Wallet Address:</label>
          <input class="py-2 border rounded-md w-full outline-none pl-6">
        </div>

        <div class="space-y-1">
          <label class="text-xs text-gray-700 font-medium">Ethereum address:</label>
          <input class="py-2 border rounded-md w-full outline-none pl-6">
          <span class="text-xs text-gray-500">We'll never share your details with anyone else</span>
        </div>
        ...
        <div class="space-y-1">
          ...
          <div class="relative">
            <div class="h-10 bg-white flex border border-gray-200 rounded items-center">
              <input id="select" value="Passport" name="select" class="px-4 text-sm appearance-none outline-none text-gray-800 w-full" checked>
            ...
            <input id="show_more" type="checkbox" name="show_more" class="hidden peer" checked>
            <div class="absolute rounded shadow bg-white overflow-hidden hidden peer-checked:flex flex-col w-full mt-1 border border-gray-200">
              <div class="cursor-pointer group">
                <a class="block p-2 text-sm border-transparent border-l-4 group-hover:border-blue-600 group-hover:bg-gray-100">Drivers Licence</a>
              </div>
              <div class="cursor-pointer group border-t">
                <a class="block p-2 text-sm border-transparent border-l-4 group-hover:border-blue-600 border-blue-600 group-hover:bg-gray-100">Passport</a>
              </div>
              <div class="cursor-pointer group border-t">
                <a class="block p-2 text-sm border-transparent border-l-4 group-hover:border-blue-600 group-hover:bg-gray-100">National ID</a>
              </div>
            </div>
          </div>

      ...
      <div class="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-900 dark:text-gray-100">
        ...
        <form class="space-y-6" @submit.prevent="login">
          <div class="space-y-1 text-sm w-full">
            ...
            <input id="username" type="text" name="username" placeholder="Username" class="border w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400">
          </div>
          <div class="space-y-1 text-sm w-full">

      ...
      <div class="px-4 py-6">
        ...
        >
          <button rel="noopener noreferrer" to="/dashboard" aria-label="Back to homepage" class="flex items-center p-2">
            <!-- <img src="@/assets/img/logo.jpeg" class="rounded-full h-10 w-10" alt="" /> -->
        ...
        <div class="space-y-3">
          ...
          <div class="flex-1">
            <ul class="pt-2 pb-4 space-y-1 text-sm">
              <!-- <li v-for="({name, url, icon}, index) in sidebarItems" :key="index" class="rounded-sm">
                <NuxtLink rel="noopener noreferrer" :to="url" class="flex items-center p-2 space-x-3 rounded-md cursor-pointer" @click="toggleNavbar">
                  <img :src="require(`~/assets/icons/${icon}.svg`)" alt="icons">
                  <p class="text-gray-100">
                    {{ name }}
                  </p>
  ...
  data () {
    return {
      ...
      sidebarItems: [
        ...
        //   name: 'Customers',
        //   icon: 'customers',
        //   url: '/admin/dashboard/deposit'
        // },
        // {
        //   name: 'Buy/Sell',
        //   icon: 'accounts',
        //   url: '/admin/dashboard/purchase-plans'
        // },
        // {
        //   name: 'Accounts',
        //   icon: 'accounts',
        //   url: '/admin/dashboard/transaction-history'
        // },
        // {
        //   name: 'Expenses',
        //   icon: 'expenses',
